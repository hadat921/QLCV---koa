...
async function convertCard(card) {
    ...
    return workbook.toFileAsync("/home/ha/Desktop/KOA/src/template/Card1.xlsx");
}
async function convertCard1(card) {
    try {
        console.log(card)
        let a = await XlsxPopulate.fromFileAsync("/home/ha/Desktop/KOA/src/template/ListCard.xlsx")
            .then(workbook => {
                console.log("----")
